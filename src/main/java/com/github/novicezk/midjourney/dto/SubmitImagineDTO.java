...
public class SubmitImagineDTO extends BaseSubmitDTO {
	...
	@ApiModelProperty(value = "垫图base64数组", position = 1)
	...
	@ApiModelProperty(value = "筛选账号执行任务，不需要筛选时设置为null或移除该参数", allowEmptyValue = true, position = 2)
