...
public class DiscordHelper {
	...
	/**
	 * MJ_DISCORD_SAYS_SERVER_URL.
	 */
	public static final String MJ_DISCORD_SAYS_SERVER_URL = "https://936929561302675456.discordsays.com";
	/**
	 * DISCORD_CDN_URL.
	 */
	...
	public String getMjSaysServer() {
		if (CharSequenceUtil.isBlank(this.properties.getNgDiscord().getMjSaysServer())) {
			return MJ_DISCORD_SAYS_SERVER_URL;
		}
		String mjDiscordSaysServerUrl = this.properties.getNgDiscord().getMjSaysServer();
		if (mjDiscordSaysServerUrl.endsWith("/")) {
			mjDiscordSaysServerUrl = mjDiscordSaysServerUrl.substring(0, mjDiscordSaysServerUrl.length() - 1);
		}
		return mjDiscordSaysServerUrl;
	}
	...
	public String getMessageHash(String imageUrl) {
		...
		if (CharSequenceUtil.contains(imageUrl, "_grid_0.webp")) {
			...
			return CharSequenceUtil.subBefore(imageUrl.substring(hashStartIndex + 1), "_grid_0.webp", true);
		}
